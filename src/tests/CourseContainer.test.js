...
describe('CourseContainer', () => {
  it('should render CourseListItem components', () => {
    ...
    const courses = mockCourseListItems

    // const component = 
    //   <Provider store={store}>
    //     <CourseContainer.WrappedComponent courseListItems={mockCourseListItems} />
    //   </Provider>;
    // const wrapper = shallow(component)

    const wrapper = shallow(<CourseContainer.WrappedComponent store={store} courses={courses}/>)
